...
cord::Schema.define(version: 20180326092117) do
  ...
  create_table "cards", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "deck_id"
    t.string "front"
    t.string "back"
    t.text "picture"
...
<<<<<<< 9131d8253a3db3a38f607895d3094cac298e76d9
...
>>>>>>> fix layout sign-up sign-in
  ...
  create_table "user_lessons", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "user_id"
    t.integer "lesson_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
